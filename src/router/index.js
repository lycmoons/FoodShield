            ...
            children: [
                {
                    ...
                    children: [
                        {
                            path: 'foodinfomanage',
                            name: 'admin-main-foodinfomanage',
                            component: () => import('@/views/admin/foodinfomanage/FoodInfoManage.vue')
                        },
                        {
                            path: 'inputfoodinfo',
                            name: 'admin-main-inputfoodinfo',
                            component: () => import('@/views/admin/foodinfomanage/InputFoodInfo.vue')
                        },
                    ]
                },
                {
